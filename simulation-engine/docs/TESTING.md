...
LLM decomposition tests require a valid LLM API key (any OpenAI-compatible provider):

```bash
export LLM_API_KEY="your-key-here"
export LLM_BASE_URL="https://api.groq.com/openai/v1"  # or any OpenAI-compatible endpoint

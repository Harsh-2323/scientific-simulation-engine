        ...
        {nodes.length === 0 ? (
          <div style={{
            ...
            <div style={{ textAlign: 'center', maxWidth: 420 }}>
              <div style={{ fontSize: 14, marginBottom: 6 }}>No DAG selected</div>
              <div style={{ fontSize: 11, lineHeight: 1.6, marginBottom: 10 }}>
                Type a research goal in the left panel and click <strong>Decompose with AI</strong> to
                auto-generate a pipeline. Or select an existing DAG from the list.
              </div>
              <div style={{ fontSize: 10, color: 'var(--text-muted)', opacity: 0.7, lineHeight: 1.6 }}>
                Try: "Run CFD simulations at 50k, 100k, and 200k mesh resolutions, then compare convergence"
              </div>
              <div style={{ fontSize: 10, marginTop: 6, color: 'var(--text-muted)', opacity: 0.5 }}>Ctrl+Enter to submit</div>
            </div>
          </div>
        ) : (
          <ReactFlow

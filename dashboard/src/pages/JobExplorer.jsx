              ...
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={7} style={{ textAlign: 'center', padding: 40, color: 'var(--text-muted)' }}>
                    <div style={{ marginBottom: 8 }}>No jobs found</div>
                    <div style={{ fontSize: 11, lineHeight: 1.6 }}>
                      Submit a job from the <strong>Submit</strong> tab, or run{' '}
                      <code style={{ background: 'var(--bg-void)', padding: '2px 5px', borderRadius: 3 }}>python scripts/seed_demo.py</code>{' '}
                      to seed demo data.
                    </div>
                  </td>
                </tr>
